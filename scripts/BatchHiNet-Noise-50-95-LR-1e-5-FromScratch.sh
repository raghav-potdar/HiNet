...
batch="Noise-50-95-LR-1e-5-FromScratch"
...
python -c "import sys; exit(0 if sys.prefix != sys.base_prefix else 1)" && {
    ...
    python3 main.py --epochs 1000 --batch_size 16 --checkpoint_every 10 --val_freq 10 --lr 1e-5 --start_epoch 0 --noise --jpeg_quality_min 50 --jpeg_quality_max 95
