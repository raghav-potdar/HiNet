...
batch="Noise-Decopuled-70-95-LR-1e-6-1e-4-200"
...
python -c "import sys; exit(0 if sys.prefix != sys.base_prefix else 1)" && {
    ...
    #Added noise
    #python3 main.py --epochs 1000 --batch_size 16 --checkpoint_every 10 --val_freq 10 --resume model/hinet_trained_till_950.pth --lr 2e-6 --start_epoch 0 --noise --jpeg_quality_min 70 --jpeg_quality_max 95
    python3 main.py --decoupled_reveal --epochs 200 --batch_size 16 --checkpoint_every 10 --val_freq 10 --lr 1e-6 --reveal_lr 1e-4 --noise --jpeg_quality_min 70 --jpeg_quality_max 95 --hide_ckpt model/hinet_trained_till_2000.pth --freeze_hide_epochs 10
